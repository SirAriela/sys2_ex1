...
int main()
{
    ...
    cout << ariel::Algorithms::Algorithm::isConnected(g) << endl;        // Should print: "0" (false).
    cout << ariel::Algorithms::Algorithm::shortestPath(g, 0, 4) << endl; // Should print: "-1" (there is no path between 0 and 4).
    cout << ariel::Algorithms::Algorithm::isContainsCycle(g) << endl;    // Should print: "The cycle is: 0->1->2->0".
    cout << ariel::Algorithms::Algorithm::isBipartite(g) << endl;        // Should print: "0" (false).
